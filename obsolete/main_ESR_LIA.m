...
exp_description = ['ESR LIA X Y 50kSps 10 min']; 
...
prm.cDAQ_channels = [4 1]; % A vector of the channels we want to record;
                       %Use cDAQ.getChannels() to get a list of available channels
prm.cDAQ_meas_time_min = 10;
prm.cDAQ_Fs = 51200; %samples/sec (instrument default is 2048; max is 51200)
