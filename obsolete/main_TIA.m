...
exp_description = ['TIA']; %60 min WR after changing Bx to D2B
...
flg.FID_Xenon =                               0;
flg.Compute_PSD =                             0;
flg.get_data_from_scope =                     1;
flg.get_data_from_cDaq =                      0; %(after measurement, data is available in the workspace in the "meas" struct)
...
% (card 1 or 2, channel 0 to3 ) [(2,0)  (2,1) (1,0) (1,1) (2,2) (2,3) (1,2) (1,3)]
% prm.cDAQ_channels =           [  1      2     3     4     5     6     7     8  ];
prm.cDAQ_channels = 6;[2 4:12]; % A vector of the channels we want to record;
                       %Use cDAQ.getChannels() to get a list of available channels
prm.cDAQ_meas_time_min = 1;
