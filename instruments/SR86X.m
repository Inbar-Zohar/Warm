classdef SR86X < handle
    ...
    methods
        ...
        function data = ShowX(obj) %Show X
            data = str2double(query(obj.Ins,'OUTP? 0'));
        end
        ...
        function setOutputOffsetState(obj,ch,stt)
            if ischar(ch)
                if strcmpi(ch,'X'); ch_ind = 0;
                elseif strcmpi(ch,'Y'); ch_ind = 1;
                elseif strcmpi(ch,'R'); ch_ind = 2;
            ...
            fprintf(obj.Ins,sprintf('COFA %d, %d',ch_ind, stt));
        end
        function setOutputOffsetStateX(obj,stt); obj.setOutputOffsetValue('X',stt); end
        function setOutputOffsetStateY(obj,stt); obj.setOutputOffsetValue('Y',stt); end
        function setOutputOffsetStateR(obj,stt); obj.setOutputOffsetValue('R',stt); end
        
        function setOutputOffsetStateXOFF(obj); obj.setOutputOffsetState('X',0); end
        function setOutputOffsetStateXON(obj); obj.setOutputOffsetState('X',1); end
        function setOutputOffsetStateYOFF(obj); obj.setOutputOffsetState('Y',0); end
        function setOutputOffsetStateYON(obj); obj.setOutputOffsetState('Y',1); end
        function setOutputOffsetStateROFF(obj); obj.setOutputOffsetState('R',0); end
        function setOutputOffsetStateRON(obj); obj.setOutputOffsetState('R',1); end

        function stt = getOutputOffsetState(obj,ch)
            if ischar(ch)
                if strcmpi(ch,'X'); ch_ind = 0;
                elseif strcmpi(ch,'Y'); ch_ind = 1;
                elseif strcmpi(ch,'R'); ch_ind = 2;
            ...
            stt = str2double(query(obj.Ins,sprintf('COFA? %d',ch_ind)));
        end
        function stt = getOutputOffsetStateX(obj); stt = getOutputOffsetState(obj,'X'); end
        function stt = getOutputOffsetStateY(obj); stt = getOutputOffsetState(obj,'Y'); end
        function stt = getOutputOffsetStateR(obj); stt = getOutputOffsetState(obj,'R'); end
        ...
        function setOutputOffsetValue(obj,ch,offset)
            ...
            if abs(offset) > 999.99; error('offset must be between -999.99 and 999.99, requested %f', offset);end
            fprintf(obj.Ins,sprintf('COFP %d, %.2f',ch_ind, offset));
        end
        ...
        function data = getOutputOffsetValue(obj,ch)
            ...
            data = str2double(query(obj.Ins,sprintf('COFP? %d',ch_ind)));
        end
        ...
        function shiftPhase(obj,val)
            obj.setPhase(obj.getPhase + val);
        end

        function shiftPhasePlus90(obj)
            obj.shiftPhase(90);
        end
        function shiftPhaseMinus90(obj)
            obj.shiftPhase(-90);
        end
        ...
        function autoOffset(obj,ch)
            ...
            fprintf(obj.Ins,sprintf('OAUT %d',ch_ind));
        end

        function autoOffsetX(obj); AutoOffset(obj,'X'); end
        function autoOffsetY(obj); AutoOffset(obj,'Y'); end
        function autoOffsetR(obj); AutoOffset(obj,'R'); end        
