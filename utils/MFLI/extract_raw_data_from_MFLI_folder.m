function [meas, prm, flg] = extract_raw_data_from_MFLI_folder(folderPath, n_files, verbose)
...
% Modular definition
isotopes = {'Xe_131', 'Xe_129', 'Sim'}; % Can be extended to any number of isotopes
demods_idxs = [3, 4, 1]; % Indices for each isotope
pid_idxs = [1, 2, 3]; % PID indices for each isotope
