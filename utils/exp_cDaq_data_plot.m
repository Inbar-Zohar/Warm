...
sensitivity_ESR = 1; 0.5; % the sensitivity of ESR LIA
...
NMR_131_X_and_R_atten_factor = 1;5.3;
LIA_ESR_gain = 10/sensitivity_ESR;
...
if analyze_ESR
    ...
    ESR_LIA_X_volt = meas.cDAQ_v(:,2)/LIA_ESR_gain;
    ESR_LIA_Y_volt = meas.cDAQ_v(:,3)/LIA_ESR_gain;
...
if analyze_NMR_129
    ...
    LIA_129_PID_volt = meas.cDAQ_v(:,2);
    LIA_129_Theta_volt = meas.cDAQ_v(:,5);
