...
% flg.analyze_rotation_signal = 0;          %1 for closed-loop analysis 
% prm.estimated_bw = 8;                     % [Hz]
% flg.plot_individual_xenons = 1;
% prm.base_fig_num = 300;
% 
% % legacy - to remove
% prm.american_lock = 1;                      % 1= PID on both NMR drives, 0= PID129 on magnetic field 
    ...
    if flg.(this_flg)
        switch this_flg
            ...
            case 'measure_world_rotation'
                func = 'measure_world_rotation_new';
